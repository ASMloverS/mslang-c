...
struct MsNode {
    ...
    union {
        ...
        // MS_ND_CALL
        struct { MsNode* callee; MsNodeList* args; MsNodeList* kwargs; } call;
        ...
        // MS_ND_IF
        struct { MsNode* cond; MsNode* thenBlock; MsNode* elseBlock; } ifStmt;
        ...
        // MS_ND_SWITCH
        struct { MsNode* expr; MsNodeList* cases; } switchStmt;
        ...
        // MS_ND_TRY
        struct { MsNode* body; MsNodeList* handlers; MsNode* finallyBlock; } tryStmt;
        ...
        struct { const char* name; MsNodeList* params; MsNode* body; bool isAsync; } funcDecl;

        // MS_ND_CLASS_DECL
        struct { const char* name; MsNode* base; MsNodeList* body; } classDecl;
